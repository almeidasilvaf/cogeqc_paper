---
title: "Supplementary Text S3: Assessing orthogroup inference in public databases"
...
vignette: |
  %\VignetteIndexEntry{Supplementary Text S3: Assessing orthogroup inference in public databases}
...
```{r compare-summary-stats, eval = TRUE}
...
```{r visualize-distros, eval = TRUE, warning = FALSE, message = FALSE, dpi = 200, fig.cap="Distribution of mean orthogroup scores."}
