---
title: "Supplementary Text S6: Assessing synteny detection in Fabaceae"
...
vignette: |
  %\VignetteIndexEntry{Supplementary Text S6: Assessing synteny detection in Fabaceae}
...
```{r save_diamond_fabaceae, echo = FALSE}
save(
    d5, compress = "xz",
...
```{r load_diamond_fabaceae, echo = FALSE}
...
```{r save_synteny_brassicaceae, echo = FALSE}
save(
...
```{r load_synteny_brassicaceae, echo = FALSE, eval = TRUE}
...
```{r assess-synteny-fabaceae, eval = TRUE}
# Assess networks
...
```{r viz-fabaceae, eval = TRUE, fig.height=6, fig.width=8, fig.cap="Scaled scores for each synteny network."}
# Plot scores
...
```{r assess-species-networks, eval = TRUE, fig.width = 8, fig.height = 6, fig.cap="Scores for species-specific synteny networks."}
