---
title: "Supplementary Text S1: Assessing the completeness of Chlorophyta genomes"
...
vignette: |
  %\VignetteIndexEntry{Supplementary Text S1: Assessing the completeness of Chlorophyta genomes}
...
Best Universal Single-Copy Orthologs (BUSCO).
...
```{r viz_busco, eval = TRUE, fig.width=13, fig.height=8, dpi=200}
