...
#| eval: true
#| fig-dpi: 200
#| fig-cap: "Orthogroup sizes for each run."
...
#| fig-width: 10
#| fig-height: 5
#| fig-cap: "Percentage of orthogroups with >50, >100, and >200 genes for each run."
...
#| fig-width: 8
#| fig-height: 6
#| fig-cap: "Distribution of mean orthogroup scores for each OrthoFinder run."
...
#| fig-height: 6
#| eval: true
#| fig-cap: "Distribution of orthogroup scores for each OrthoFinder run calculated for each species separately."
...
#| fig-height: 5
#| fig-dpi: 200
#| fig-cap: "Effect of MCL inflation values on orthogroup scores."
...
#| fig-height: 6
#| fig-dpi: 200
#| fig-cap: "Effect of DIAMOND mode on orthogroup scores."
...
```{r plot-distros-with-groups}
#| eval: true
#| fig-cap: "Distribution of mean homogeneity scores for orthogroups"
...
#| fig-height: 9
#| fig-width: 20
#| fig-cap: "Tree plot of functional terms associated with each orthogroup cluster."
...
#| eval: true
#| fig-dpi: 200
#| fig-cap: "Dotplot of functional terms associated with each orthogroup cluster."
...
Next, let's explore a potential association between the two variables. Here,
since the distribution of homogeneity scores is highly right-skewed, we will
perform a correlation test using Spearman's $\rho$ as a measure of association.
...
#| fig-width: 8
#| fig-height: 5
#| fig-cap: "Relationship between sequence length and orthogroup scores."
...
The data and correlation test show that there is a significant negative 
correlation between homogeneity and OG gene length, but the correlation 
is weak ($\rho = -0.19$).
